...
import openpi.policies.coral_param_filters as coral_param_filters
...
_CONFIGS = [
    ...
    # PiStar-CORAL block1: PiStar advantage conditioning trained only in the
    # hot-switchable CORAL expert subset.  Keep pi0.5 discrete state and Piper
    # delta-action semantics identical to the original CORAL block1 policy.
    TrainConfig(
        name="pi05_star_coral_piper_block1_r0",
        project_name="pistar-coral",
        model=pi0_config.Pi0Config(
        ...
        data=LeRobotPiperDataConfig(
            repo_id="piper/assemble_block1_coral_pistar_policy850_r0",
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=True,
            side_image_key="side_image",
        ),
        ...
        optimizer=_optimizer.AdamW(clip_gradient_norm=1.0),
        freeze_filter=coral_param_filters.get_coral_freeze_filter(
            (
        ...
        # Reconstruct the successful CORAL block1 initialization from the shared
        # pi05 base plus its exported 62-leaf expert subset.
        weight_loader=weight_loaders.CheckpointOverlayWeightLoader(
            base_params_path="/mnt/pi05_base/params",
            overlay_params_path="/workspaces/coral_block1_init/lora_params",
        ),
        ema_decay=None,
        num_train_steps=10_000,
        save_interval=1_000,
    ...
    # PiStar-CORAL block2 r0.  This intentionally mirrors block1's model,
    # optimizer, action representation, and trainable CORAL parameter subset,
    # while keeping the dataset and initialization expert task-specific.
    TrainConfig(
        name="pi05_star_coral_piper_block2_r0",
        project_name="pistar-coral",
        model=pi0_config.Pi0Config(
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
        ...
        data=LeRobotPiperDataConfig(
            repo_id="piper/assemble_block2_coral_pistar_policy850_r0",
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=True,
            side_image_key="side_image",
        ),
        ...
        # Reconstruct the original block2 CORAL policy from the shared pi05
        # base plus its exported 62-leaf hot-switchable expert subset.
        weight_loader=weight_loaders.CheckpointOverlayWeightLoader(
            base_params_path="/mnt/pi05_base/params",
            overlay_params_path="/workspaces/data/pistar_coral/coral_block2_init/lora_params",
        ),
        ema_decay=None,
        num_train_steps=10_000,
        save_interval=1_000,
    ...
    # The hot CORAL runtime loads pi05_base once and overlays exported PiStar-CORAL
    # expert parameters.  beta=2.0 matches the established PiStar inference path.
    TrainConfig(
        name="pi05_star_coral_piper_infer",
        project_name="pistar-coral",
        model=pi0_config.Pi0Config(
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
        ...
        weight_loader=weight_loaders.CheckpointWeightLoader("/mnt/pi05_base/params"),
        ema_decay=None,
    ),
    #
